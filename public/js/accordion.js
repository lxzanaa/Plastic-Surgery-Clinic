...
let mobileAccordionBtns = document.querySelectorAll('#mobile-accordion-btn')

mobileAccordionBtns.forEach(function (faqBtn, index) {
  faqBtn.addEventListener('click', function () {
    let mobileAccordionInfo = document.querySelectorAll(
      '#mobile-accordion-info'
    )[index]
    mobileAccordionInfo.classList.toggle('max-h-0')
    mobileAccordionInfo.classList.toggle('max-h-full')
  })
})
